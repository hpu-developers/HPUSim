"""
  This module implements an integer multiplier.
"""
...
class Multiplier(FunctionalUnit):
  ...
  def run_new_task_if_given(self, task):
    ...
    if((task is not None) and (task['accelerator'] == self.name)):
      ...
      ## debug
      print("Performing multiplication in mult!")
