"""
  This module implements an integer subtracter.
"""
...
class Subtracter(FunctionalUnit):
  """
  ...
  def run_new_task_if_given(self, task):
    ...
    if((task is not None) and (task['accelerator'] == self.name)):
      ...
      ## debug
      print("Performing subtraction in sub!")
...
if __name__ == "__main__":
  ...
  job_end = 0
  for i in range(0, iCPU['sub']['cycles']-1):
