...
class FPMultiplier(FunctionalUnit):
  """
  ...
  def run_new_task_if_given(self, task):
    ...
    if((task is not None) and (task['accelerator'] == self.name)):
      ...
      ## debug
      print("Performing multiplication in fpmult!")
...
if __name__ == "__main__":
  ...
  job_end = 0
  for i in range(0, iCPU['fmul']['cycles']-1):
